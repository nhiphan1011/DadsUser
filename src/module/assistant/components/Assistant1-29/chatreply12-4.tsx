...
//         start: boolean, showEnd: boolean, loading: boolean, ask: boolean,
//         again: boolean,
//         request: boolean, selectDisable: boolean,
//         // btnDisable: boolean,
//         disabled: boolean
//     }>({
//         // start: false,
...
//                         setText(prev => ({ ...prev, bot: "", exam: TextBotAskAgain }))
...
//         }
//         if (index.YN === 0 && count.textBotExample === 3) console.log("Do not count textbotexample")
...
//         if (index.options[0] < 0) setIndex(prev => ({ ...prev, options: [i] }))
//         else setIndex(prev => ({ ...prev, options: [...index.options, i] }));
//         setText(prev => ({ ...prev, user: e.target.textContent }));
...
//         bg-[${index.options[0] === i ? "#EBE1FF" : "#F2F4F5"}] 
//         text-[${index.options[0] === i ? "#120360" : "primary"}] 
//         hover:bg-[${index.options[0] < 0 ? "#EBE1FF" : "#F2F4F5"}]
//         hover:text-[${index.options[0] < 0 ? "#120360" : "primary"}]
//         `}>
//                     {item}
//                 </button>
//             );
//         })}
//     </div>
//     const AskAgainComponent = ({ indexState }: { indexState: number }) => {
...
//                         key={i}
//                         className={`w-[30%] flex justify-center items-center text-center rounded-[12px] mx-2.5 p-6 hover:cursor-pointer
//                               bg-[${indexState === i ? "#EBE1FF" : "#F2F4F5"}]
//                               text-[${indexState === i ? "#120360" : "primary"}]
//                               hover:bg-[${indexState < 0 ? "#EBE1FF" : "#F2F4F5"}]
//                               hover:text-[${indexState < 0 ? "#120360" : "primary"}]
//                                   `}
//                     >
//                         {item}
//                     </button>
...
//         </div>)
//     }
//     const OptionAgainComponent = ({ arr, value, indexO }: { arr: Array<string>, value: string, indexO: number }) => {
//         const result = arr.filter(element => element !== value)
//         return (
//             <div id="options" className={`flex flex-wrap justify-center mb-2.5`}>
//                 {result.map((item: any, i: any) => {
//                     return (
//                         <button
//                             onClick={(e) => {
//                                 if (count.reply === 6 && index.YN === 0 && count.ask === 0) handleOption(e, i)
//                             }}
//                             key={i}
//                             className={`fadeIn w-fit max-w-[20%] min-w-[45%] md:min-w-[20%] option flex justify-center items-center text-center rounded-[12px] m-2.5 p-6 first-letter:p-6 hover:cursor-pointer break-words
//         bg-[${index.options[indexO] === i ? "#EBE1FF" : "#F2F4F5"}] 
//         text-[${index.options[indexO] === i ? "#120360" : "primary"}] 
//         hover:bg-[${index.options.length < indexO + 1 ? "#EBE1FF" : "#F2F4F5"}]
//         hover:text-[${index.options.length < indexO + 1 ? "#120360" : "primary"}]
//         `}>
//                             {item}
//                         </button>
//                     );
...
//             onClick={async (e) => {
//                 if (index.obj === 0) {
//                     if (index.YN === 0 && index.ask === 1 && count.reply === 7) handleSendEmail()
...
//                         {boxChat.boxChat5.length >= 2 && index.YN === 0 && <AskAgainComponent indexState={index.ask} />}
...
//                         {boxChat.boxChat6.length >= 2 && index.YN === 0 && index.ask === 0 && <OptionAgainComponent arr={value.optionBot} value={value.optionBot[index.options[0]]} indexO={1} />}
//                         {boxChat.boxChat6.length >= 1 && index.ask === 1 && state.request && RequestEndComponent}
