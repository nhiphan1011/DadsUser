...
//     const [index, setIndex] = useState<{ start: number, obj: number, YN: number, YN1: number, topic: number, options: Array<number>, ask: number, end: number }>({
//         start: -1,
//         obj: -1,
//         YN: -1,
//         YN1: -1,
...
//         heightOptions: 0
//     })
//     const [state, setState] = useState<{ start: boolean, showEnd: boolean, loading: boolean, again: boolean, request: boolean, btnDisable: boolean, disabled: boolean }>({
//         // start: false,
//         start: true,
//         loading: false,
...
//         boxChat1: Array<any>, boxChat2: Array<any>, boxChat3: Array<any>, boxChat4: Array<any>, boxChat5: Array<any>, boxChat6: Array<any>, boxChat7: Array<any>, ask1: Array<any>, boxChatEnd: Array<any>,
//     }>({
//         boxChat1: [],
//         boxChat2: [],
//         boxChat3: [],
...
//             // if (source) setText(prev => ({ ...prev, bot: source.data.data }))
//             setText(prev => ({ ...prev, bot: "Call Data lần 1" }))
//         }
//         if (topic) {
//             // const _topic = encodeURIComponent(topic.toLowerCase())
...
//                             // }, 2000)
//                             setText(prev => ({ ...prev, bot: "", exam: TextBotAskAgain[count.ask] }))
...
//                 } else if (countReply === 6) {
//                     // if (count.ask < 0) {
//                     //     setBoxChat(prev => ({ ...prev, boxChat6: [...boxChat.boxChat3, { user: "bot", value: messageBot }] }))
//                     // } else if (state.again) {
//                     //     setBoxChat(prev => ({ ...prev, ask: { ...boxChat.ask, 1: [...boxChat.ask[1], { user: "bot", value: messageBot }] } }))
...
//         }
//         if (index.obj === 0 && index.YN === 0 && count.reply === 5) console.log("obj0 YN0")
//         else setCount(prev => ({ ...prev, textBotExample: count.textBotExample + 1 }))
//     };
...
//             setCount(prev => ({ ...prev, reply: count.reply + 1 }))
//             if (i === 1) setCount(prev => ({ ...prev, textBotExample: count.textBotExample + 2 }))
//         }
//     }
...
//             <img src="/static/media/Bot.e33d536bdd412e738363.png" alt="" className="w-[50px] h-[50px] object-contain" />
...
//                         if (state.again === false || i === 1) setCount(prev => ({ ...prev, reply: count.reply + 1 }))
...
//                         key={i}
//                         className={`w-[30%] flex justify-center items-center text-center rounded-[12px] mx-2.5 p-6 hover:cursor-pointer
//                     bg-[${index.ask === i ? "#EBE1FF" : "#F2F4F5"}] 
//                     text-[${index.ask === i ? "#120360" : "primary"}] 
//                     hover:bg-[${index.ask < 0 ? "#EBE1FF" : "#F2F4F5"}]
//                     hover:text-[${index.ask < 0 ? "#120360" : "primary"}]
//                         `}
//                     >
//                         {item}
//                     </button>
...
//                         {boxChat.boxChat2.length >= 2 && index.obj === 0 && <YesNoButtonComponent index={index.YN} />}
...
//                         {/* {boxChat.boxChat5.length >= 2 && index.YN === 0 && count.ask >= -1 && <AskAgainComponent />} */}
...
//                         {index.ask === 1 && state.request && RequestEndComponent}
//                         {index.ask === 1 && state.request && state.showEnd && ShowEndComponent}
...
//             <div className='boxchat-footer md:w-[60%] md:ml-auto py-[10px]'>
