...
//                                     hover:bg-[${indexStart < 0 ? "blue" : "#F2F4F5"}]
//                                     hover:text-[${indexStart < 0 ? "white" : "primary"}]
//                                     `}
//                                 >
//                                     {item}
//                                 </div>
...
//                                             key={i}
//                                             className={`w-[full] flex justify-center items-center text-center rounded-[12px] p-6 hover:cursor-pointer
//                                             bg-[${indexTopic2 === i ? "blue" : "#F2F4F5"}] 
//                                             text-[${indexTopic2 === i ? "white" : "primary"}] 
//                                             hover:bg-[${indexTopic2 < 0 ? "blue" : "#F2F4F5"}]
//                                             hover:text-[${indexTopic2 < 0 ? "white" : "primary"}]
//                                             `}
//                                         >
//                                             {item}
//                                         </div>
