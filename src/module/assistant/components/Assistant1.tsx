...
//                 } else {
//                     setLoading(false)
//                     setTextBotExample(TextBotExample[6]) //dành cho case index 1&2
//                     source.close()
//                 }
...
//         if (messageUser) {
//             console.log("Running in meassage user")
...
//             setTextBot("")
//         }
//         if (Topic.includes(messageUser) && nochat) {
...
//         setIndexStart(i)
//         setCountReply(countReply => countReply + 1)
//         i === 0 ? setNoChat(true) : ref.current.focus() //
//     }
...
//         console.dir(document.getElementById("message"), "message")
//         post("", "", "", "", "", message)
//         // setMessage("")
//     }
...
//                         }}
//                         key={i}
//                         className={`bg-[${indexEnd === i ? "blue" : "#F2F4F5"
//                             }] w-[30%] flex justify-center items-center text-center text-[${indexEnd === i ? "white" : "primary"
...
//                 <div id="boxchat" className='box-wrap h-full p-8 transition  overflow-y-scroll overflow-x-hidden relative'>
//                     {/* Bot */}
...
//                                         if (indexStart === 1) ref.current.focus() // bấm bao nhiu lần chat now cũng auto focus
//                                     }}
//                                     key={i}
...
//                         </div>
//                     )}
//                     {countTextBotExample >= 3 && indexYN === 0 && (
...
//                             e.preventDefault()
//                             setText(message)
//                             if (countReply < 0) setCountReply(countReply => countReply + 1)
