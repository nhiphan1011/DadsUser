...
const LoginButton = ({ handleLogin }: ILoginButton) => {
  return (
    <button
      type="button"
      id="loginButton"
      className="text-white bg-black hover:bg-black-100 border border-black-200 focus:ring-2 focus:outline-none focus:ring-black-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-black-600 dark:bg-black-800 dark:border-black-700 dark:text-white dark:hover:bg-black-700 mr-2 mb-2"
      onClick={handleLogin}
    >
      <svg
        aria-hidden="true"
      ...
      <span id="walletID">Connect with MetaMask</span>
    </button>
  );
};
